class GuestAgent:
    ...
    def create_user(username, groups=None, home=None):
        '''
        Create a user with the provided username. If groups and home are provided, include the user
        in those groups and with that home directory
        '''
        raise NotImplementedError

    def get_osinfo():
        '''
        gets info about the os on which the guest is running. Info includes kernel release, kernel version, 
        machine, id and name. 
        '''
        raise NotImplementedError
